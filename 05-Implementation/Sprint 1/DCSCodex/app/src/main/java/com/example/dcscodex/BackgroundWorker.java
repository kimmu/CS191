...
*
* Borja, Kim                    02/01/16                    Created onPreExecute, onPostExecute, and onProgressUpdate method        
*
* Borja, Kim                    02/02/16                    Edited if-else statements under onPostExecute method         
*
     ...
     protected String doInBackground(String... params) {
          ...
          if (type.equals("login")) {
               try {
                    ...
                    String user_id = params[1];         /* catches the student number passed as parameter from LoginActivity */
