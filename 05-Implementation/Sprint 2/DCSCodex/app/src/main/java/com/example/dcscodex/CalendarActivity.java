...
*
* Borja, Kim                    02/21/16                    Added necessary comments
*
*
*/
...
public class CalendarActivity extends AppCompatActivity {
     ...
     String json_url = "http://192.168.254.111/fetchevents_dcscodex.php";  /* must always be checked and replaced by the current IP address */
     String date = null;
